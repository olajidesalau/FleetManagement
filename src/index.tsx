...
app.get('/messages/new', authenticate, async (c) => {
  try {
    ...
    return c.html(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Conversation - Snow Fleet Management</title><link href="/static/style.css" rel="stylesheet"></head><body><nav class="topbar"><div class="nav-shell"><div class="brand-lockup"><span class="brand-mark">S</span><span>Snow Fleet <em>Management</em></span></div><div class="primary-nav"><a href="/">Overview</a><a href="/routes">Routes</a><a href="/vehicles">Vehicles</a><a href="/temperature">Temperature</a><a href="/drivers">Drivers</a><a href="/customers">Customers</a><a href="/alerts">Alerts</a><a href="/monitoring">Monitoring</a><a href="/traffic">Traffic</a><a class="active" href="/messages">Messages</a></div><div class="user-menu"><a href="/profile">${escapeHtml(user.email || 'Account')}</a></div></div></nav><main class="fleet-dashboard conversation-page"><div class="page-heading"><div><p class="eyebrow">Profile messaging</p><h1>Conversation with ${escapeHtml(otherUser.full_name || otherUser.email)}</h1><p class="header-copy">Send a message securely to this profile.</p></div><a class="button button-secondary" href="/messages">Back to messages</a></div><section class="panel conversation-card"><div class="conversation-messages">${messageMarkup}</div><form data-conversation-form data-receiver-id="${receiverId}" style="display:flex;gap:.5rem"><input name="message_text" maxlength="4000" placeholder="Type your message..." required><button type="submit">Send</button></form></section></main><script src="https://cdn.jsdelivr.net/npm/axios@1.6.0/dist/axios.min.js"></script><script src="/static/app.js"></script></body></html>`)
  } catch {
...
app.get('/messages/conversation/:conversationId', authenticate, async (c) => {
  try {
    ...
    return c.html(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Conversation - Snow Fleet Management</title><link href="/static/style.css" rel="stylesheet"></head><body><nav class="topbar"><div class="nav-shell"><div class="brand-lockup"><span class="brand-mark">S</span><span>Snow Fleet <em>Management</em></span></div><div class="primary-nav"><a href="/">Overview</a><a href="/routes">Routes</a><a href="/vehicles">Vehicles</a><a href="/temperature">Temperature</a><a href="/drivers">Drivers</a><a href="/customers">Customers</a><a href="/alerts">Alerts</a><a href="/monitoring">Monitoring</a><a href="/traffic">Traffic</a><a class="active" href="/messages">Messages</a></div><div class="user-menu"><a href="/profile">${escapeHtml(user.email || 'Account')}</a></div></div></nav><main class="fleet-dashboard conversation-page"><div class="page-heading"><div><p class="eyebrow">Profile messaging</p><h1>Conversation with ${escapeHtml(otherUser?.full_name || otherUser?.email || 'Fleet contact')}</h1><p class="header-copy">Send a message securely to this profile.</p></div><a class="button button-secondary" href="/messages">Back to messages</a></div><section class="panel conversation-card"><div class="conversation-messages">${messageMarkup}</div><form data-conversation-form data-receiver-id="${escapeHtml(otherId)}" style="display:flex;gap:.5rem"><input name="message_text" maxlength="4000" placeholder="Type your message..." required><button type="submit">Send</button></form></section></main><script src="https://cdn.jsdelivr.net/npm/axios@1.6.0/dist/axios.min.js"></script><script src="/static/app.js"></script></body></html>`)
  } catch (error: any) {
